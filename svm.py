...
x_train = np.array(x[0:41,:]).reshape((41,2))
y_train = np.array(y[0:41,:]).reshape((41,1))
x_test = np.array(x[41:48,:]).reshape((6,2))
y_test = np.array(y[41:48,:]).reshape((6,1))

test_num = y_test.size
clf = svm.SVC(C=15, kernel='linear', decision_function_shape='ovr')
